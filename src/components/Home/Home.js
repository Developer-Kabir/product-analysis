...
const Home = () => {
    return (
        <div>
            <div className='gelary d-flex'>
                <div className='w-50 px-4 mt-4'>
                ...
                <div className='w-50 px-3'>
                    <img className='img-fluid rounded' src="https://images.pexels.com/photos/170811/pexels-photo-170811.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                </div>
            </div>
